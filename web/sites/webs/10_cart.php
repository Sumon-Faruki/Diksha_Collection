...
foreach ($_SESSION['cart'] as $id => $qnty) {
	...
	<tr>
			...
			<td align='center'><img src='../../../admin/3_product/pro_images/$row[image]' height='40' width='40'></td>
			<td align='center'>&#8377;$row[price]</td>
			<td align='center'>$qnty</td>
			<td align='center'>&#8377;".$tot."</td>

			<td align='center'>
			<a href='9_addToCart.php?pid=$id&op=add'> 
                <i class='fas fa-plus-circle'></i>
            </td>
			
			<td align='center'>
			<a href='9_addToCart.php?pid=$id&op=del'>
			<i class='fas fa-minus-square'></i></td>
			

			<td align='center'>
			<a href='9_addToCart.php?pid=$id&op=rem'>
...
<form action="11_checkOut.php" method="post">
